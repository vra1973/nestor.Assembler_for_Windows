...
title db 'Простой Текстовый Редактор. Vasylenko Roman (2021)v01',0
...
db 'All files',0,'*.*',0,0
fn_saved db 0 ;флаг имени файла 1=сохранено, 0=нет
...
dialogitem 'STATIC',<'Простой Текстовый Редактор',0Dh,0Ah,'Vasylenko Roman Andreevich. 2021.v01.'>,-1,27,10,144,40,WS_VISIBLE+SS_CENTER
dialogitem 'STATIC',IDI_MAIN,-1,8,8,32,32,WS_VISIBLE+SS_ICON
dialogitem 'STATIC','',-1,4,34,164,11,WS_VISIBLE+SS_ETCHEDHORZ
dialogitem 'STATIC','Написан при помощи компилятора FASM',-1,12,42,100,20,WS_VISIBLE+SS_LEFT
